...
"""
# Физически не понимаю как реализовать. Могу предположить, что это невозможно, так как в какой то момент на последней смене не удастся удовлетворить потребности
#366/7=364 с остатком 2
import sqlite3
