...
def my_t9(input_numbers: str) -> List[str]:
    slovar={'2':['a' ,'b', 'c'],'3':['d', 'e', 'f'],'4':['g', 'h','i'],'5':['j', 'k', 'l'],'6':['m','n','o'],
            '7':['p','q','r','s'],'8':['t','u','v'],'9':['w','x','y','z']}
    spisokcifr=input_numbers.split('')
    dlina_slova=len(spisokcifr)
    spisok_slov=[]
    ...
    for i in spisokcifr:
        list+=slovar[i]
    for i in f:
        if len(i)==dlina_slova and any(item in i for item in list):
            spisok_slov.append(i)
        else:
            pass
